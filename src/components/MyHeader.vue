      ...
      <div class="container flex-lg-row flex-nowrap align-items-center">
        <div class="navbar-brand w-100">
          <router-link to="/">
            <img
              class="logo-dark"
              src="/assets/img/logo-blueshield.dark.png"
              srcset="/assets/img/logo-blueshield.dark.png"
              style="max-height: 150px; max-width: 120px; margin-top: 20px; margin-left: 50px;"
              alt="photo"
            />
            <img
              class="logo-light"
              src="/assets/img/logo-blueshield.light.png"
              srcset="/assets/img/logo-blueshield.light.png"
              style="max-height: 150px; max-width: 120px; margin-top: 20px; margin-left: 50px;"
              alt="photo"
            />
          </router-link>
...
import HeadersComponentsLinks from "@/components/Links.vue";
import MyMenu from "@/components/MyMenu.vue";

import HeadersComponentsSocials from "@/components/Socials.vue";
