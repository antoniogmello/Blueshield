...
export const features2 = [
  {
    ...
    text: "Menos despesas com subsídios, segurança social, formação e férias.",
  },
  {
    id: 2,
    iconClass: "uil uil-check",
    text: "Gestão eficiente e segura das áreas de recursos humanos e proteção de dados.",
  },
  {
    id: 3,
    iconClass: "uil uil-check",
    text: "Foco a 100% no seu negócio.",
  },
];
...
export const serviceFeatures = [
  ...
  },
  {
    id: 2,
    icon: "uil uil-shield-exclamation",
    title: "Desenvolvimento e Liderança de Equipas",
    description: "Vivamus sagittis lacus augue laoreet vel.",
  },
  {
    id: 3,
    icon: "uil uil-laptop-cloud",
    title: "Compliance Laboral e Consultoria Jurídica",
    description: "Cras mattis consectetur purus sit amet.",
  },
  {
    id: 4,
    icon: "uil uil-chart-line",
    title: "Planeamento Estratégico de Recursos Humanos",
    description: "Aenean lacinia bibendum nulla sed consectetur.",
  },
];

export const serviceFeaturesHr = [
  {
    id: 1,
    icon: "uil uil-search-alt",
    title: "Recrutamento e Seleção",
    description:
      "Ajudar a sua empresa a atrair e selecionar os melhores talentos, alinhados com a cultura organizacional e as necessidades do negócio.",
  },
  {
    id: 2,
    ...
    title: "Desenvolvimento e Liderança de Equipas",
    description:
      "Capacitamos os lideres e as suas equipas a alcançarem uma performance de alto rendimento e trabalharem de forma colaborativa e eficiente.",
  },
  {
    id: 3,
    ...
    title: "Compliance Laboral e Consultoria Jurídica",
    description:
      "Ajudamos a sua empresa a garantir o cumprimento dos normativos legais e regulamentares assegurando o compliance laboral.",
  },
  {
    id: 4,
    ...
    title: "Planeamento Estratégico de Recursos Humanos",
    description:
      "Ajudamos a sua empresa a desenvolver estratégias alinhadas com os objetivos de longo prazo da sua empresa.",
  },
];

export const serviceFeaturesDp = [
  {
    id: 1,
    icon: "uil uil-book-alt",
    title: "Programas e Auditorias RGPD",
    description:
      "Desenvolvimento de todos os documentos, políticas, procedimentos e processos que garantem a conformidade com a legislação em vigor.",
  },
  {
    id: 2,
    ...
    description:
      "Auditorias às organizações, através da realização de entrevistas, análise de documentos e revisão de processos, tendo por objetivo a identificação de desconformidades.",
  },
  {
    id: 3,
    icon: "uil uil-laptop-cloud",
    title: "Acompanhamento de Incidentes de Violação de Dados",
    description:
      "Apoio às organizações na resolução de violações de dados, através da reparação ou mitigação de impactos.",
  },
  {
    id: 4,
    icon: "uil uil-presentation-check",
    title: "Formação e Sensiblização de Workshops",
    description:
      "Ações de formação em proteção de dados, dado as características e necessidades de cada organização.",
  },
];
...
export const infoItems = [
  {
    ...
    title: "Visão",
    description:
      "Ser a referência na integração de soluções de Recursos Humanos e Proteção de Dados, promovendo ambientes de trabalho seguros, éticos e centrados nas pessoas. ",
  },
  {
    number: 2,
    title: "Missão",
    description:
      "Capacitar empresas a crescer de forma sustentável, garantindo que cada indivíduo e dado estejam protegidos com excelência e integridade.",
  },
  {
    number: 3,
    title: "Valores",
    description:
      "    Colocamos as pessoas no centro de tudo o que fazemos, garantindo que os dados, privacidade e integridade estejam sempre salvaguardadas",
  },
];
